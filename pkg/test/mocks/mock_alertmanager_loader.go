...
//
//	mockgen -package=mocks -mock_names=Loader=MockAlertManagerLoader -source=loader.go -destination=../test/mocks/mock_alertmanager_loader.go
//
...
func (mr *MockAlertManagerLoaderMockRecorder) ActiveAlertsWithLabels(labels any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
