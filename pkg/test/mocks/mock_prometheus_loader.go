...
//
//	mockgen -package=mocks -mock_names=Loader=MockPrometheusLoader -source=loader.go -destination=../test/mocks/mock_prometheus_loader.go
//
...
func (mr *MockPrometheusLoaderMockRecorder) LoadAlertsRange(ctx, start, end, step any) *gomock.Call {
...
func (mr *MockPrometheusLoaderMockRecorder) LoadQuery(ctx, query, t any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPrometheusLoaderMockRecorder) LoadVectorRange(ctx, query, start, end, step any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
